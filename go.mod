module github.com/ownLover/goapp

go 1.12

replace (
	cloud.google.com/go => github.com/GoogleCloudPlatform/google-cloud-go v0.38.0
	github.com/ownLover/goapp/internal => ./internal
	github.com/ownLover/goapp/pkg => ./pkg
...
require (
	github.com/ownLover/goapp/internal v0.0.0-00010101000000-000000000000
	github.com/ownLover/goapp/pkg v0.0.0-00010101000000-000000000000 // indirect
)
